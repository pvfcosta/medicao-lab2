...
lmplot = sns.lmplot(x='popularity',y='loc',data=ckResultsGraph,fit_reg=True) 
lmplot.savefig('graphs/lm_popularity_loc.png') 
print("Coeficiente de correlação popularidade x loc : ")
print(ckResultsGraph['popularity'].corr(ckResultsGraph['loc']))
...
lmplot = sns.lmplot(x='releases',y='loc',data=ckResultsGraph,fit_reg=True) 
lmplot.savefig('graphs/lm_releases_loc.png') 
print("Coeficiente de correlação releases x loc : ")
print(ckResultsGraph['releases'].corr(ckResultsGraph['loc']))
...
lmplot = sns.lmplot(x='age',y='loc',data=ckResultsGraph,fit_reg=True) 
lmplot.savefig('graphs/lm_age_loc.png') 
print("Coeficiente de correlação age x loc : ")
print(ckResultsGraph['age'].corr(ckResultsGraph['loc']))
